...
public class UTS {
    public static void main(String[] args) {
        ...
        //Data penjualan
        int[] penjualan = {7600, 8200, 8460, 8200, 7900, 7600, 7700, 8300, 8900, 9360, 9500};
        ...
        if (rd2[periode]<rd3[periode] && rd2[periode]<rd4[periode]){
            System.out.println("Berdasarkan nilai relative deviation terkecil  yaitu pada orde bulan 2 sebesar "+rd2[periode]+"%, dipilih data peramalan orde 2 bulan yakni diperkirakan terjual "+ramalan2[periode]+" unit" );
        }
        else if (rd3[periode]<rd2[periode] && rd3[periode]<rd4[periode]){
            System.out.println("Berdasarkan nilai relative deviation terkecil  yaitu pada orde bulan 3 sebesar "+rd3[periode]+"%, dipilih data peramalan orde 3 bulan yakni diperkirakan terjual "+ramalan3[periode]+" unit" );
        }
        else if (rd4[periode]<rd3[periode] && rd4[periode]<rd2[periode]){
            System.out.println("Berdasarkan nilai relative deviation terkecil  yaitu pada orde bulan 4 sebesar "+rd4[periode]+"%, dipilih data peramalan orde 4 bulan yakni diperkirakan terjual "+ramalan4[periode]+" unit" );
        }
        System.out.println();
